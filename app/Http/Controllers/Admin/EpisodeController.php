...
class EpisodeController extends Controller {
    ...
    public function addEpisodeVideo($id) {
        ...
        return view('admin.item.video.update', compact('pageTitle', 'episode', 'video', 'prevUrl', 'item', 'route', 'episodeId'));
    }
    ...
    public function storeEpisodeVideo(Request $request, $id) {
        ...
        $video->save();
        return response()->json(['success' => 'Video uploaded successfully', 'redirect' => route('admin.item.episodes', $episode->item_id)]);
    }
    ...
    public function updateEpisodeVideo($id) {
        ...
        $prevUrl   = route('admin.item.episodes', $episode->item_id);
        $episodeId = $episode->id;
        return view('admin.item.video.update', compact('pageTitle', 'video', 'posterImage', 'videoFile', 'prevUrl', 'route', 'item', 'episodeId'));
    }
