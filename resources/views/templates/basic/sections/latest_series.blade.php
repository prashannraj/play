<section class="movie-section section my-80" data-section="single2">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                    ...
                    <div class="movie-item">
                        <div class="movie-thumb">
                            ...
                            <div class="movie-thumb-overlay">
                                <a class="video-icon" href="{{ route('watch', $latestSeries->slug) }}"><i
...
<div class="add-area ad-section my-80">
    <div class="container">
