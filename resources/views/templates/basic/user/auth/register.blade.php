...
@section('app')
    ...
    <section class="account-section bg-overlay-black bg_img"
        data-background="{{ frontendImage('register', @$register->data_values->background_image, '1780x760') }}">
        <div class="container">
                ...
                <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-8">
                    <div class="account-form-area @if (!gs('registration')) form-disabled @endif">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                    ...
                                    <g>
                                        <path
                                            ...
                                            fill="hsl(var(--base))" opacity="1" data-original="hsl(var(--base))"
                                            class=""></path>
                                        <path
                        ...
                        <form class="account-form verify-gcaptcha" action="{{ route('user.register') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control form--control checkUser" id="email" name="email"
                                    ...
                                    <div class="col-lg-12 form-group">
                                        <div class="checkbox-wrapper">
                                            <div class="checkbox-item custom--checkbox">
                                                <input class="checkbox--input" id="agree" name="agree"
                                                    type="checkbox">
                        ...
                        <div class="text-center mt-3">
                            <span class="fs-12">@lang('Already Have An Account?') <a class="text--base"
                                    href="{{ route('user.login') }}">@lang('Login Now')</a></span>
                        </div>
                    </div>
                </div>
            </div>
