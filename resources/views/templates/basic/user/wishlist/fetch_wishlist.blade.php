    ...
    <li class="wishlist-card-list__item">
        <div class="wishlist-card-wrapper">
                ...
                <div class="wishlist-card">
                    <div class="wishlist-card__thumb">
                        @if ($wishlist->episode_id)
                            <img src="{{ getImage(getFilePath('episode') . '/' . @$wishlist->episode->image) }}"
                                alt="@lang('image')">
                        @else
                            <img src="{{ getImage(getFilePath('item_portrait') . '/' . @$wishlist->item->image->portrait) }}"
                                alt="@lang('image')">
                        @endif
                    </div>
            ...
            <div class="wishlist-card-wrapper__icon">
                <button class="basicConfirmationBtn" data-action="{{ route('user.wishlist.remove', $wishlist->id) }}"
