<section class="section mt-80 mb-80" data-section="single2">
                    ...
                    <div class="movie-card" data-text="{{ $latestSeries->versionName }}">
                        <div class="movie-card__thumb thumb__2">
                            <img class="lazy-loading-img"
                                data-src="{{ getImage(getFilePath('item_portrait') . '/' . $latestSeries->image->portrait) }}"
                                src="{{ asset('assets/global/images/lazy.png') }}" alt="image">
                            <a class="icon" href="{{ route('watch', $latestSeries->slug) }}"><i
