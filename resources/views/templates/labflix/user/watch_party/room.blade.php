...
@section('content')
    <section class="watch-party-section mt-80 mb-80 pt-80">
        <div class="container">
            <div class="row justify-content-center">
                    ...
                    <div class="watch-party-video-info">
                        <div class="top">
                            ...
                            @if ($partyRoom->user_id == auth()->id())
                                <button class="btn btn--danger cancelPartyBtn"
                                    data-action="{{ route('user.watch.party.cancel', $partyRoom->id) }}"
                                    type="button">@lang('Cancel Party')</button>
                            @else
                                <button class="btn btn--danger leavePartyBtn"
                                    data-action="{{ route('user.watch.party.leave', [$partyRoom->id, auth()->id()]) }}"
                                    type="button">@lang('Leave Party')</button>
                            @endif
                        </div>
                        <div class="bottom">
                            <div class="author">
                                <div class="thumb">
                                    <img src="{{ getImage(getFilePath('userProfile') . '/' . @$partyRoom->user->image, getFileSize('userProfile'), true) }}"
                                        alt="">
                                </div>
                                <div>
                                    @if ($partyRoom->user_id == auth()->id())
                            ...
                            @if ($partyRoom->user_id == auth()->id())
                                <div class="code-box">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="party-code" value="{{ $partyRoom->party_code }}"
                                            readonly>
                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="chat-box" id="liveChat">
                        ...
                        <div class="chat-body chatBodyScroll" id="chatBodyScroll">
                            @foreach ($conversations as $conversation)
                                @include('Template::partials.single_message', [
                    ...
                    <div class="chat-box d-none" id="joinList">
                        <div class="chat-header">
                            <button class="btn-transparent d-inline-flex align-items-center chatBtn"><i
                                    class="las la-arrow-left"></i> @lang('Chat')</button>
                        </div>
                        <div class="chat-body chatBodyScroll" id="chatJoinBodyScroll">
                            @foreach ($partyMembers as $partyMember)
                                @include('Template::partials.join_list')
                            @endforeach
                        </div>
                    </div>
                </div>
    ...
    <div class="modal alert-modal" id="partyStatusModal">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form method="POST" id="statusFormSubmit">
    ...
    <div class="modal alert-modal" id="cancelPartyModal">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form method="POST" id="cancelFormSubmit">
                    <div class="modal-body">
                        <span class="alert-icon"><i class="fas fa-question-circle"></i></span>
                        <p class="modal-description">@lang('Confirmation Alert!')</p>
    ...
    <div class="modal alert-modal" id="leavePartyModal">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form method="POST" id="leaveFormSubmit">
                    <div class="modal-body">
                        <span class="alert-icon"><i class="fas fa-question-circle"></i></span>
                        <p class="modal-description">@lang('Confirmation Alert!')</p>
