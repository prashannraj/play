...
@section('content')
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-xl-12 position-relative">
                    ...
                    <div class="text-end mb-3">
                        <button type="button" class="btn btn--light joinPartyBtn">@lang('Join Party')</button>
                    </div>
                    <div class="">
                        <div class="">
                            <ul class="wishlist-card-list">
                                @include('Template::user.watch_party.fetch_party', [
                                    'parties' => $parties,
                                ])
                            </ul>
                        </div>
                ...
                @if (@$total > 20 && @$lastId)
                    <div class="load-more-button d-flex justify-content-center mt-5">
                        <button class="cmn-btn" id="load-more-btn" data-last_id="{{ @$lastId }}"
    ...
    <div class="modal alert-modal" id="joinWatchParty">
