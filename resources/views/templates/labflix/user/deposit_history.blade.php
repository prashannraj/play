                        ...
                        <tbody>
                            @forelse($deposits as $k => $deposit)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if ($deposit->admin_feedback != null)
                                            <button class="btn--info btn-rounded badge detailBtn"
                                                    data-admin_feedback="{{ $deposit->admin_feedback }}"><i
                                    ...
                                    <td>
                                        @if ($deposit->method_code >= 1000 && $deposit->method_code <= 5000)
                                            <a href="javascript:void(0)" class="btn-outline--light btn btn--sm detailBtn"
                                        ...
                                        @else
                                            <button type="button" class="btn--light btn btn--sm" data-bs-toggle="tooltip"
                ...
                if (userData) {
                    userData.forEach(element => {
                        if (element.type != 'file') {
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <span>${element.name}</span>
                                <span"><a href="${element.value}" class="base--color"><i class="fa-regular fa-file"></i> @lang('Attachment')</a></span>
                            </li>`;
                        }
                    });
                }
