...
@section('panel')
    <div class="row gy-4">
        ...
        @if (gs('ffmpeg') && shell_exec('which ffmpeg'))
            <div class="col-md-12">
                <div class="card bl--5 border--danger">
                    <div class="card-body">
                        <p class="text--dark">
                            <strong>@lang('FFmpeg Not Detected:')</strong> @lang('FFmpeg is not currently available on this server. Some video-related features may not work properly.') <br>
                            @lang('Please ensure FFmpeg is installed and accessible via the system path. Contact your hosting provider or server administrator to enable it.')
                        </p>
                    </div>
                </div>
            </div>
