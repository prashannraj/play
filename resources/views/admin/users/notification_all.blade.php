            ...
            $('select[name=being_sent_to]').on('change', function(e) {
                ...
                if (methodName == 'SELECTEDUSERS') {
                    ...
                    <div class="form-group" id="user_list_wrapper">
                        <label class="required">@lang('Select Users')</label>
                        <select name="user[]"  class="form-control" id="user_list" required multiple >
                            <option disabled>@lang("$viaText will be sent again with a")</option>
                        </select>
                    </div>
                    `);
                    fetchUserList();
                ...
                if (methodName == 'TOPDEPOSITEDUSERS') {
                    $('.input-append').html(`
                    <div class="form-group">
                        <label class="required">@lang(' second delay. Avoid closing or refreshing the browser.')</label>
                ...
                if (methodName == 'NOTLOGINUSERS') {
                    $('.input-append').html(`
                    <div class="form-group">
                        <label class="required">@lang(' ' . (isset($sessionData['total_sent']) ? $sessionData['total_sent'] : 0) . ' out of ' . (isset($sessionData['total_user']) ? $sessionData['total_user'] : 0) . ' ' . $viaName . ' were successfully transmitted')</label>
                        <div class="input-group">
                            ...
                            <span class="input-group-text">@lang('Send Via Email')</span>
                        </div>
                    </div>
                    `);
                    return;
