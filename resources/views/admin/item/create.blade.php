                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-end flex-wrap gap-3">
                            ...
                            <div class="form-group">
                                <button class="btn btn-outline--dark fetchBtn h-45" type="button"><i
                                       class="las la-server"></i> @lang('Fetch')</button>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="input-group">
                                    <input class="form-control" name="ratings" type="number"
                                           value="{{ old('ratings') }}" step="any" max="10" required>
                        ...
                        <div class="row">
                            <div class="col-md-3 form-group">
                                <label>@lang('Send Notification to Users')</label>
                                <input name="notify_to_users" data-width="100%" data-size="large" data-onstyle="-success"
                                       data-offstyle="-danger" data-bs-toggle="toggle" data-height="50" data-on="@lang('Yes')" data-off="@lang('No')" type="checkbox">
                            </div>
                            <div class="col-md-3 form-group">
                                <label>@lang('Send Notification to Subscriber')</label>
