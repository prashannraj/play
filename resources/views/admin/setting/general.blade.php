                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="file_server" data-minimum-results-for-search="-1">
                                        ...
                                        <option value="digital_ocean" @selected(gs('server') == 'digital_ocean')>@lang('Digital Ocean')
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2-auto-tokenize genres-option" name="genres[]" multiple="multiple" {{ gs('genre') ? 'required' : '' }}>
                                        @foreach ($genres as $genre)
                                            <option value="{{ $genre }}" {{ in_array($genre, $selectedGenre ?? []) ? 'selected' : '' }}>{{ $genre }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center my-2">
                                <h5 class="me-4"> @lang('Socket Configuration') </h5>
                                <a href="{{ route('admin.setting.socket.documentation') }}" class="btn btn--sm btn-outline--primary"> <i class="las la-info-circle"></i> @lang('Documentation')</a>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang('App URI')</label>
                                    <input class="form-control" name="socket_appuri" type="text" value="{{ gs('socket_appuri') }}" required>
                                </div>
                            </div>
                        </div>
