...
@section('content')
    <section class="my-80">
        <div class="container">
                        ...
                        <div class="tv-details-wrapper">
                            <div class="tv-details__content">
                                ...
                                <div class="tv-details__social-share">
                                    <ul class="post-share d-flex align-items-center justify-content-end flex-wrap">
            ...
            <div class="tv-details__sidebar mt-5">
                <div class="tv-details__header">
                    <h3 class="tv-details__sidebar-title mb-3">@lang('Other Tv Channels')</h3>
                </div>
