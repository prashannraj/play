...
@section('content')
    <section class="my-80">
        <div class="container">
            <ul class="nav nav-pills event--tab" id="pills-tab" role="tablist">
                        ...
                        <div class="tv-live">
                            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
                                <div class="d-flex flex-wrap gap-2 gap-md-3 align-items-center">
                                    <h4 class="channel-title mb-0">{{ __($category->name) }} @lang('Channels')</h4>
                                    @if (!$eligable)
                                        <button class="btn btn-outline--light btn--sm channelSubscribeBtn"
            ...
            <div class="modal-content">
                <form method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-outline--light btn--sm" type="submit">@lang('Yes')</button>
                    </div>
                </form>
            </div>
        </div>
