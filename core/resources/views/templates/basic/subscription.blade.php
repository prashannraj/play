...
@section('content')
    <section class="plan-section my-80">
        <div class="container">
                            ...
                            <div class="plan-content">
                                ...
                                <ul class="package-benifits">
                                    <li class="package-benifits-item">
                                        <span class="package-benifits-icon"><i
                                                class="las la-check"></i></span>@lang('Get ' . $plan->duration . ' days subscription')
                                    </li>
                                    <li class="package-benifits-item">
                                        <span class="package-benifits-icon"><i
                                                class="las la-check"></i></span>@lang('Show Ads - ')
                                        {{ __($plan->showAdStatus) }}
                                    </li>
                                    @if (gs('device_limit'))
                                        <li class="package-benifits-item">
                                            <span class="package-benifits-icon"><i class="las la-check"></i></span>
                                            @lang('Connect with ' . $plan->device_limit . ' device')
                                        </li>
                                    @endif
                                </ul>
                                ...
                                <div class="plan-content-btn">
                                    @auth
                                        <button class="btn btn-outline--light w-100 subscriptionBtn"
                                            data-action="{{ route('user.subscribe.plan', $plan->id) }}"
                                            @disabled($user->exp > now())>@lang('Subscribe Now')</button>
                                    @else
                                        <button class="btn btn-outline--light w-100 subscribeBtn"
                                            type="button">@lang('Subscribe Now')</button>
                                    @endauth
                                </div>
                            </div>
                        </div>
