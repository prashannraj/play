...
<head>
    ...
    <link href="{{ asset(activeTemplate(true) . 'css/vendor/animate.min.css') }}" rel="stylesheet">
    <link href="{{ asset(activeTemplate(true) . 'css/vendor/nice-select.css') }}" rel="stylesheet">
    <link href="{{ asset(activeTemplate(true) . 'css/vendor/slick.css') }}" rel="stylesheet">
...
<body @stack('context')>
    ...
    @if ($cookie->data_values->status == Status::ENABLE && !\Cookie::get('gdpr_cookie'))
        <div class="cookies-card hide text-center">
            ...
            <p class="cookies-card__content mt-4">{{ @$cookie->data_values->short_desc }} <a class="base--color"
    ...
    <script src="{{ asset(activeTemplate(true) . 'js/vendor/lightcase.js') }}"></script>
    <script src="{{ asset(activeTemplate(true) . 'js/vendor/jquery.nice-select.min.js') }}"></script>
    ...
    <script src="{{ asset(activeTemplate(true) . 'js/vendor/jquery.countdown.js') }}"></script>
    <script src="{{ asset(activeTemplate(true) . 'js/vendor/jquery.slimscroll.min.js') }}"></script>
