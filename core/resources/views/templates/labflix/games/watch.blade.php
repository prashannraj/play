        ...
        <div class="container">
            <div class="row gy-4 justify-content-center">
                <div class="col-lg-8 pe-lg-5">
                    <div class="movie-item-wrapper h-auto">
                        <div class="movie-item">
                            <video playsinline class="video-player"
                                poster="{{ getImage(getFilePath('game') . '/' . $game->image, getFileSize('game')) }}">
                                <source src="{{ $game->link }}">
                            </video>
                        </div>
                    </div>

                    <ul class="event--tab nav nav-pills mb-0 mt-5" id="pills-tab" role="tablist">
                            ...
                            <div class="chat">
                                ...
                                <div class="chat__footer">
                                    ...
                                    <small class="note-text-info">
                                        <i class="las la-info-circle"></i> @lang('All messages you send will appear publicly')
                                    </small>
                                </div>
...
@push('script')
    ...
    @if (!empty(gs('control_socket')))
        <script>
            window.liveTvConfig = {
                liveTvId: `{{ request()->id ?? '' }}`,
                commentStoreRoute: `{{ route('live-game.comments.store') }}`,
                commentGetRoute: `{{ route('live-game.comments.get', ['liveTvId' => request()->id ?? '']) }}`,
