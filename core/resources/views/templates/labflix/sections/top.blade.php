<section class="section mt-80 mb-80" data-section="latest_series">
        ...
        <div class="row gy-3">
            <div class="col-xxl-3 col-xl-4 col-lg-6 col-sm-6">
                ...
                <ul class="movie-small-list">
                    @foreach ($trendingItems as $trending)
                        <li class="movie-small">
                            <div class="movie-small__thumb">
                                <img class="lazy-loading-img"
                                    data-src="{{ getImage(getFilePath('item_portrait') . '/' . $trending->image->portrait) }}"
                                    src="{{ asset('assets/global/images/lazy.png') }}" alt="image">
                            </div>
                            <div class="movie-small__content">
                                <h5>{{ __($trending->title) }}</h5>
                                <ul class="movie-card__meta">
                                    <li><i class="far fa-eye color--primary"></i>
                                        <span>{{ __(numFormat($trending->view)) }}</span></li>
                                    <li><i class="fas fa-star color--gold"></i>
                                        <span>({{ __($trending->ratings) }})</span></li>
                                </ul>
            ...
            <div class="col-xxl-3 col-xl-4 col-lg-6 col-sm-6">
                ...
                <ul class="movie-small-list">
                    @foreach ($topRatedItems as $topRated)
                        <li class="movie-small">
                            <div class="movie-small__thumb">
                                <img class="lazy-loading-img"
                                    data-src="{{ getImage(getFilePath('item_portrait') . '/' . $topRated->image->portrait) }}"
                                    src="{{ asset('assets/global/images/lazy.png') }}" alt="image">
                            </div>
                            <div class="movie-small__content">
                                ...
                                <ul class="movie-card__meta">
                                    <li><i class="far fa-eye color--primary"></i>
                                        <span>{{ __(numFormat($topRated->view)) }}</span></li>
                                    <li><i class="fas fa-star color--gold"></i>
                                        <span>({{ __($topRated->ratings) }})</span></li>
                                </ul>
            ...
            <div class="col-xxl-6 col-xl-4">
                <div class="single-movie">
                    <div class="single-movie__thumb">
                        <img class="w-100 lazy-loading-img"
                            data-src="{{ getImage(getFilePath('item_landscape') . '/' . @$mostViewsTrailer->image->landscape) }}"
                            alt="image" ssrc="{{ asset('assets/global/images/lazy_one.png') }}">
                    </div>
                    @if (@$mostViewsTrailer)
...
<div class="ad-section mt-80 mb-80">
    <div class="container">
