<?php
    ...
    if ($action == 'result') {
        ...
        if (isset($response['error']) && $response['error'] == 'ok' && $_POST['db_type'] == 'create-new-database') {
            try {
                ...
                echo "</pre>";
                $createDbError = ((isset($createDbResult->data->error) && $createDbResult->data->error) ? $createDbResult->data->error : null) ?? ((isset($createDbResult->data->reason) && $createDbResult->data->reason) ? $createDbResult->data->reason : null) ?? ((isset($createDbResult->error) && $createDbResult->error) ? $createDbResult->error : null);
                if ($createDbResult == false) {
                    throw new Exception($cpError);
                } else if ($createDbError) {
                    $cpError = $createDbError ?? $cpError;
                    $cpError = (isset($createDbResult->data->reason) && $createDbResult->data->reason) ? "Error from cPanel: " . $cpError : $cpError;
                    throw new Exception($cpError);
                }
                ...
                $createUserError  = ((isset($createUserResult->data->error) && $createUserResult->data->error) ? $createUserResult->data->error : null) ?? ((isset($createUserResult->data->reason) && $createUserResult->data->reason) ? $createUserResult->data->reason : null) ?? ((isset($createUserResult->error) && $createUserResult->error) ? $createUserResult->error : null);
                if ($createUserResult == false) {
                    throw new Exception($cpError);
                } else if ($createUserError) {
                    $cpError = $createUserError ?? $cpError;
                    $cpError = (isset($createUserResult->data->reason) && $createUserResult->data->reason) ? "Error from cPanel: " . $cpError : $cpError;
                    throw new Exception($cpError);
                }
                ...
                $assignError    = ((isset($assignDbResult->data->error) && $assignDbResult->data->error) ? $assignDbResult->data->error : null) ?? ((isset($assignDbResult->data->reason) && $assignDbResult->data->reason) ? $assignDbResult->data->reason : null) ?? ((isset($assignDbResult->error) && $assignDbResult->error) ? $assignDbResult->error : null);
